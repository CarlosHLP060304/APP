...
DocumentReference? get currentUserReference =>
    loggedIn ? QuizCollectionRecord.collection.doc(currentUser!.uid) : null;

QuizCollectionRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : QuizCollectionRecord.getDocument(
                  QuizCollectionRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
